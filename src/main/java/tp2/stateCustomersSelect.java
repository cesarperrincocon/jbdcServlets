 ...
 * @author cperrinc
 */
@WebServlet(name = "stateCustomersSelect", urlPatterns = {"/stateCustomersSelect"})
public class stateCustomersSelect extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                LinkedList<String> statesList = dao.myStatesList();
